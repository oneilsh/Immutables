...
Plain `for (v in ix)` (without `loop()`) does *not* dispatch to the iteration protocol — it walks the underlying finger-tree storage and yields internal nodes rather than elements. Always wrap with `loop()`.
