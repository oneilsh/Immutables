...
testthat::test_that("interval_index casts down to flexseq explicitly", {
  ...
  testthat::expect_true(all(c(".size", ".named_count", "width_sum") %in% ms_full))
  testthat::expect_false(".ivx_max_start" %in% ms_full)
  testthat::expect_false(".ivx_max_end" %in% ms_full)
